...
nmap("<Leader>g", "<cmd>lua require('fzf-lua').live_grep_native({ cwd = require('utils').git_root() })<CR>")
nmap("<Leader>G", "<cmd>lua require('fzf-lua').live_grep_native()<CR>")
nmap("<Leader>tt", "<cmd>lua require('fzf-lua').builtin()<CR>")
nmap("<Leader>ti", "<cmd>lua require('fzf-lua').files({ cwd = '~/.config/nvim' })<CR>")
nmap("<Leader>td", "<cmd>lua require('fzf-lua').files({ cwd = '~/dotfiles' })<CR>")
nmap("<Leader>td", "<cmd>lua require('fzf-lua').files({ cwd = '~/dotfiles' })<CR>")
